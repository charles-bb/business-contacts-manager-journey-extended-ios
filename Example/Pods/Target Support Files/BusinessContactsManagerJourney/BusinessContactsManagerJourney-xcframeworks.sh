...
install_xcframework "${PODS_ROOT}/BusinessContactsManagerJourney/BusinessContactsManagerJourney.xcframework" "BusinessContactsManagerJourney" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
