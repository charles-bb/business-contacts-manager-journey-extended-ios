...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BusinessContactsManagerJourneyExtended/BusinessContactsManagerJourneyExtended.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/BusinessContactsManagerJourney/BusinessContactsManagerJourney.framework"
