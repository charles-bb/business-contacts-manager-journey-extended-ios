...
install_xcframework "${PODS_ROOT}/BackbaseDesignSystem/BackbaseDesignSystem.xcframework" "BackbaseDesignSystem" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
